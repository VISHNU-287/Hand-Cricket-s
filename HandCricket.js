...
function CoinToss(){
  ...
  //Creating the Storage Center
   ...
   function Reset(){
    ...
    localStorage.removeItem('record');
          ...
          UserLiveRun();
          UserLiveStokes();
          document.getElementById('id-100').innerHTML = `Toss To Play!!`;
 ...
 Decision();
   ...
   else if(storage.opponentout ===1){
    alert('Opponent Already Out');
   }
    }
...
else if(storage.myout === 1){
  alert('User ALREADY OUT!!');
}
